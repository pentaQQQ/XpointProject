...
//    .heightIs(20);
    ...
    .widthIs([self widthLabelWithModel:@"519581205461602304" withFont:13]+5)
    .heightIs(10);
    
    self.allGoodPrice = [[UILabel alloc] init];
    self.allGoodPrice.textAlignment = NSTextAlignmentRight;
    self.allGoodPrice.text = @"¥10000";
    ...
    .topSpaceToView(self.goodIcon, 10)
    .rightSpaceToView(self.contentView, 15)
    .widthIs([self widthLabelWithModel:@"¥10000" withFont:13])
    .heightIs(10);
    ...
    .leftSpaceToView(self.goodOrderNumber, 5)
    .heightIs(10);
...
-(void)configWithModel:(OrderDetailModel *)model andMineIndentModel:(MineIndentModel *)minModel
{
    ...
    self.allGoodPrice.text = [NSString stringWithFormat:@"%.2lf",model.totalAmount];
