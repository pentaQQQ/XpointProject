...
//
    ...
    .rightSpaceToView(self.goodArrow, 20)
    .heightIs(40);
...
-(void)configWithModel:(NSMutableArray *)model
{
    ...
    self.goodIcon.image = [UIImage imageNamed:@"我的订单_08"];
    self.goodName.text = model[1];
    self.goodSize.text = [NSString stringWithFormat:@"规格: %@",model[2]];
    self.goodNumber.text = [NSString stringWithFormat:@"x%@",model[3]];
    self.goodOrderNumber.text = model[4];

    self.allGoodNumber.text = [NSString stringWithFormat:@"共%@件",model[5]];
    self.allGoodPrice.text = [NSString stringWithFormat:@"%@元",model[6]];
    self.goodStatus.text = model[7];
    
    if ([model[8] isEqualToString:@"1"]) {
        ...
        [self.cancelGoodsBtn setTitle:@"取消" forState:UIControlStateNormal];
        ...
        .widthIs(70)
        .heightIs(30);
    }else if ([model[8] isEqualToString:@"2"]){
        ...
        .widthIs(70)
        .heightIs(30);
    }else if ([model[8] isEqualToString:@"3"]){
...
//        self.deliverGoodsBtn.alpha = 0;
    }else if ([model[8] isEqualToString:@"4"]){
        ...
        .widthIs(70)
        .heightIs(30);
    }else if ([model[8] isEqualToString:@"5"]){
